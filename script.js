jQuery(document).ready(function () {
	...
	function collectData() {
		...
		var sensor_data = {
			...
			role:t.contact.role.toString(),
			text:t.contact.text.toString(),
			content:t.contact.content.toString(),
			solution:t.solution,
			q1:t.data[0].question.toString(),
			q1a:t.data[0].data.toString(),
			q2:t.data[1].question.toString(),
			q2a:t.data[1].data.toString(),
			q3:t.data[2].question.toString(),
			q3a:t.data[2].data.toString(),
			q4:t.data[3].question.toString(),
			q4a:t.data[3].data.toString(),
			q5:t.data[4].question.toString(),
			q5a:t.data[4].data.toString(),
			q6:t.data[5].question.toString(),
			q6a:t.data[5].data.toString(),
			q7:t.data[6].question.toString(),
			q7a:t.data[6].data.toString(),
			q8:t.data[7].question.toString(),
			q8a:t.data[7].data.toString(),
		}
