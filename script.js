jQuery(document).ready(function () {
	...
	function collectData() {
		...
		var sensor_data = {
			name:t.contact.name,
			campany:t.contact.campany,
			phone_number:t.contact.phone_number,
			role:t.contact.role,
			text:t.contact.text,
			content:t.contact.content,
			solution:t.solution,
			q1:t.data[0].question,
			q1a:t.data[0].data,
			q2:t.data[1].question,
			q2a:t.data[1].data,
			q3:t.data[2].question,
			q3a:t.data[2].data,
			q4:t.data[3].question,
			q4a:t.data[3].data,
			q5:t.data[4].question,
			q5a:t.data[4].data,
			q6:t.data[5].question,
			q6a:t.data[5].data,
			q7:t.data[6].question,
			q7a:t.data[6].data,
			q8:t.data[7].question,
			q8a:t.data[7].data,
		}
